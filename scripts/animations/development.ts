...
export const development: AnimationSet = {
  ...
  hammer: {
    ...
    stroke: {
      ...
      whole: {
        rotate: [0, -5.7, 7.1, 0],
        // The head sits ~207 units from the grip it pivots on, so the strike alone
        // carries it past the edge of the box. Losing 5% of size while it swings
        // keeps the whole hammer inside without shortening the throw.
        scale: [1, 0.95, 0.95, 1],
        origin: [56, 200],
